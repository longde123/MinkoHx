...
class LightMaskFilter extends AbstractFilter {
    ...
    private var _rootPropertyChangedSlots:List<SignalSlot3<Store, Provider, String>>;

    private var _layoutMaskChangedSlots:List<SignalSlot2<Provider, String>>;
    ...
    public function new() {
        ...
        this._target = null;
        this._root = null;
        this._providerToLight = new ObjectMap<Provider, AbstractLight>();
        this._rootPropertyChangedSlots = new List<SignalSlot3<Store, Provider, String>>();
    }

    private function reset() {
        _root = null;
        _providerToLight = new ObjectMap<Provider, AbstractLight>();
