...
class MeshPartitionerOptions {
    private var instanceFieldsInitialized:Bool ;

    static private function initializeInstanceFields() {
        return all = mergeSurfaces | createOneNodePerSurface | applyCrackFreePolicy;
    }
    ...
    private var partitionMaxSizeFunction:MeshPartitionerOptions -> NodeSet -> Vec3;
...
class MeshPartitioner extends AbstractWriterPreprocessor  {
    private var _options:MeshPartitionerOptions;
    ...
    public static function create(options:MeshPartitionerOptions, streamingOptions:StreamingOptions) {
