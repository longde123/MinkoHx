...
class ColorBySpeed extends ModifierVec31 implements IParticleUpdater {
    private static var PROPERTY_NAMES:Array<String> = [ "particles.colorBySpeedStart", "particles.colorBySpeedEnd" ];

    public static function create(sampler:LinearlyInterpolatedValueVec3) {
        var ptr = new ColorBySpeed(sampler);
