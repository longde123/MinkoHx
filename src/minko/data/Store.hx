...
class Store extends Enable_uuid {
    ...
    public function dispose() {
        ...
        if (_propertyNameToChangedSignal != null) {
            for(_p in _propertyNameToChangedSignal)
                _p.dispose();
        ...
        if (_propertyNameToAddedSignal != null) {
            for(_p in _propertyNameToAddedSignal)
                _p.dispose();
        ...
        if (_propertyNameToRemovedSignal != null) {
            for(_p in _propertyNameToRemovedSignal)
                _p.dispose();
    ...
    public function propertyHasType(propertyName) {
    ...
    public function getUnsafePointer(propertyName) {
        var providerAndToken = getProviderByPropertyName(propertyName);
        var provider = providerAndToken.first;
    ...
    public function addProviderbyName(provider, collectionName) {
    ...
    public function removeProviderbyName(provider, collectionName) {
    ...
    public function hasPropertyAddedSignal(propertyName) {
        return _propertyNameToAddedSignal.exists(propertyName) ;
    }


    public function hasPropertyRemovedSignal(propertyName) {
        return _propertyNameToRemovedSignal.exists(propertyName) ;
    }

    public function hasPropertyChangedSignal(propertyName) {
    ...
    public function doRemoveProvider(provider:Provider, ?collection:Collection = null) {
        ...
        for (property in provider.values.keys()) {
        ...
        if (collection == null) {
            for (nameAndValue in provider.values.keys()) {
