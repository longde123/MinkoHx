...
class MathUtil {
    ...
    inline public static function Vector3_add(v:Vec3, scalar:Float) {

        return v + scalar ;
    }

    inline public static function Vector3_sub(v:Vec3, scalar:Float) {

        return v - scalar ;
    }

    inline public static function Vector3_div(v:Vec3, scalar:Float) {
        return v / scalar ;
    }
    ...
    inline public static function mat3_mult_vec3(m:Mat3, v:Vec3) {
        return Mat3.multVecOp(m, v);
    }
    ...
    public static function mat4_equals(a:Mat4, b:Mat4) {
        return a.equals(b);
    ...
    inline public static function getp2(x) {
        var tmp = x;
        var p = 0;
        while (tmp >= 1) {
            ++p;
