...
class StartForce extends Modifier3 implements IParticleInitializer {
    public static function create(fx:Sampler<Float>, fy:Sampler<Float>, fz:Sampler<Float>) {
        var modifier = new StartForce(fx, fy, fz);

        return modifier;
    }

    public function new(fx:Sampler<Float>, fy:Sampler<Float>, fz:Sampler<Float>) {
        super(fx, fy, fz);
    }
