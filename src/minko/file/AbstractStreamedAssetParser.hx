...
//private var _progress :Signal2<AbstractStreamedAssetParser, Float>;
    ...
    public function lodRangeRequestByteRange(lowerLod:Int, upperLod:Int, offset:Int, size:Int) {
    ...
    public function lodRequestFetchingComplete(data:Bytes) {
        if (_jobManager) {
            ...
            }, function() {lodRequestComplete.execute((this));
    ...
    function nextLod(previousLod, requiredLod, nextLod, nextLodOffset, nextLodSize) {
        ...
        lodRangeFetchingBound(previousLod, requiredLod, lodRangeMinSize, lodRangeMaxSize, lodRangeRequestMinSize, lodRangeRequestMaxSize);
    ...
    function parseStreamedAssetHeader() {
        ...
        _loaderCompleteSlot = _linkedAsset.complete.connect(function(linkedAsset:LinkedAsset, linkedAssetData:Bytes) {
            ...
            var streamedAssetHeaderSize = assetHeaderSize + (linkedAssetData[streamedAssetHeaderSizeOffset] << 8) + linkedAssetData[streamedAssetHeaderSizeOffset + 1];
