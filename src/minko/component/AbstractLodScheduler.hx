...
class AbstractLodScheduler extends AbstractComponent {
    ...
    override public function targetAdded(target:Node) {
        ...
        _sceneManagerFunction = defaultSceneManagerFunction;

        _rendererFunction = defaultRendererFunction;

        _masterLodSchedulerFunction = defaultMasterLodSchedulerFunction;
    ...
    public function rendererSet(renderer:Renderer) {
        if (renderer == null) {
