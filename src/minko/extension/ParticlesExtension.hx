...
//msgpack.type.tuple<@uint, @uint, IdAndString>
    ...
    public function deserializeFloatSampler(id:SamplerId, serialized:Bytes):Sampler<Float> {
        switch (id)
        {
    ...
    public function deserializeColorSampler(id:SamplerId, serialized:Bytes):Sampler<Vec3> {
        switch (id)
        {
    ...
    public function deserializeConstantNumberSampler(serialized:Bytes):Sampler<Float> {
        var dst = new BytesInput(serialized);
    ...
    public function deserializeLinearNumberSampler(serialized:Bytes):Sampler<Float> {
        var dst = new BytesInput(serialized);
    ...
    public function deserializeRandomNumberSampler(serialized:Bytes):Sampler<Float> {
        var dst = new BytesInput(serialized);
    ...
    public function deserializeConstantColorSampler(serialized:Bytes):Sampler<Vec3> {
        var dst = new BytesInput(serialized);
    ...
    public function deserializeLinearColorSampler(serialized:Bytes):Sampler<Vec3> {
        var dst = new BytesInput(serialized);
    ...
    public function deserializeRandomColorSampler(serialized:Bytes):Sampler<Vec3> {
        var dst = new BytesInput(serialized);
