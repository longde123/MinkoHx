...
//Debug.Assert(math.GlobalMembers.isp2(_widthGPU) && math.GlobalMembers.isp2(_heightGPU));
        ...
        _data[ face] = resizeData(_width, _height, data, _widthGPU, _heightGPU, _resizeSmoothly);
    }
...
//Debug.Assert(math.GlobalMembers.isp2(width) && math.GlobalMembers.isp2(height));
        ...
        for (faceId in 0... 6) {
            ...
            _data[faceId] = resizeData(previousWidth, previousHeight, previousData, width, height, resizeSmoothly);
        }
