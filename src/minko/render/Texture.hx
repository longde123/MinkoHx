...
class Texture extends AbstractTexture {
    ...
    public function setData(data:Bytes, widthGPU, heightGPU) {
        ...
        if (!TextureFormatInfo.isCompressed(_format)) {
            ...
            rgba = resizeData(_width, _height, rgba, _widthGPU, _heightGPU, _resizeSmoothly);
            _data.push(rgba);
        }
        else {
...
//var mipMapDataBegin = dataOffset;//data().begin() + dataOffset;
//var mipMapDataEnd = mipMapDataBegin + TextureFormatInfo.textureSize(_format, mipMapPreviousWidth, mipMapPreviousHeight);
            var mipMapData:Bytes = Bytes.alloc(TextureFormatInfo.textureSize(_format, mipMapPreviousWidth, mipMapPreviousHeight));


            var newMipMapData:Bytes = resizeData(mipMapPreviousWidth, mipMapPreviousHeight, mipMapData, mipMapWidth, mipMapHeight, resizeSmoothly);
