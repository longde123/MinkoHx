...
class Keyboard {
    ...
    public function getKeyDown(key) {
        var index:Int = key;
    ...
    public function keyIsDown(key) {
        return false;
    }

    public function hasKeyDownSignal(key) {
        return _keyDown.exists(key);
    }

    public function hasKeyUpSignal(key) {
    ...
    public function setKeyboardState(key, state) {

    }

    private static function initializeKeyNames() {
