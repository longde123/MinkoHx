...
class EffectParserTest extends haxe.unit.TestCase {
    ...
    inline function checkStateBindingWithDefaultValue(effectFile, stateName, defaultValue) {
    ...
    inline function checkSamplerStateDefaultValue(filename, samplerStateProperty, defaultValue) {
        var fx = loadEffect(filename);
        assertFalse(fx == null);
        assertEquals(Lambda.count(fx.techniques), 1);
        var defaults:Array<Pass> = fx.techniques.get("default");
    ...
    inline function checkSamplerStateBindingWithDefaultValue(filename, samplerStateProperty, defaultValue) {
        var fx = loadEffect(filename);
        assertFalse(fx == null);
        assertEquals(Lambda.count(fx.techniques), 1);
        var defaults:Array<Pass> = fx.techniques.get("default");
