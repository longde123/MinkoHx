...
import minko.file.MeshPartitioner.MeshPartitionerOptions;
...
class StreamingOptions {
    ...
    private var _meshPartitionerOptions:MeshPartitionerOptions;
    ...
    private var _streamedTextureMaxMipLevel:Int;
    ...
    public var meshPartitionerOptions(get, set):MeshPartitionerOptions;
    ...
    public var popGeometryLodRangeFetchingBoundFunction(get, set):Int -> Int -> Int -> Int -> Int -> Int -> minko.Tuple.Tuple4<Int,Int,Int,Int>;
