...
class POPGeometryWriterPreprocessorOptions {
    ...
    private static var all= computeVertexColor | smoothVertexColor;
...
class POPGeometryWriterPreprocessor extends AbstractWriterPreprocessor  {


    private var _options:POPGeometryWriterPreprocessorOptions;
    ...
    public var options(null, set):POPGeometryWriterPreprocessorOptions;
    ...
    override public function process(writable:Dynamic, assetLibrary:AssetLibrary) {
        var node:Node=cast writable;
    // TODO
